...
<script>
	function edit(id,eid){
		var nazov = document.getElementById(id).textContent;
		document.getElementById(id).innerHTML="<input type='hidden' name='id' vaule='"+id+"'><input type='text' name='"+id+"' placeholder='"+nazov+"'>";
		document.getElementById(eid).innerHTML="<input type='submit' value='Uložiť'>";
	}
