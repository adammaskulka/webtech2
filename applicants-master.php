<?php 
	...
	if(isset($_GET['lang'])){
		...
		header("Location: applicants-master.php");
		exit();
	}
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-4">
                <h1>For Applicants for Study - Engineering Study</h1>
            </div>
            <div class="col-lg-8 col-sm-8">
                <ol class="breadcrumb pull-right">
                    <li><a href="index.php">Home</a></li>
                    <li class="active">For Applicants for Study - Engineering Study</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container career-inner">
        <div class="row">
            <div class="col-md-12 career-head">
                <h1 class="wow fadeIn">For Applicants for Study - Engineering Study</h1>
