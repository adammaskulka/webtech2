<?php 
	...
	if(isset($_GET['lang'])){
		...
		header("Location: bachelor-thesis.php");
		exit();
	}
...
<head>
    ...
    <title>
        Ústav automobilovej mechatroniky FEI STU | Bakalárske práce | Témy
    </title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-4">
                <h1>Bachelor Thesis - Themes</h1>
            </div>
            <div class="col-lg-8 col-sm-8">
                <ol class="breadcrumb pull-right">
                    <li><a href="index.php">Home</a></li>
                    <li class="active">Bachelor Thesis - Themes</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container career-inner">
        <div class="row">
            <div class="col-md-12 career-head">
                <h1 class="wow fadeIn">Bachelor Thesis - Free Themes</h1>
...
<div class="breadcrumbs">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-4">
                <h1>Bakalárske práce - Témy</h1>
            </div>
            <div class="col-lg-8 col-sm-8">
                <ol class="breadcrumb pull-right">
                    <li><a href="index.php">Domov</a></li>
                    <li class="active">Bakalárske práce - Témy</li>
                </ol>
            </div>
        </div>
    </div>
