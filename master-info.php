<?php 
	...
	if(isset($_GET['lang'])){
		...
		header("Location: master-info.php");
		exit();
	}
...
<head>
    ...
    <title>
        Ústav automobilovej mechatroniky FEI STU | Inžinierske štúdium | Všeobecné informácie
    </title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-4">
                <h1>Engineering Study - General Information</h1>
            </div>
            <div class="col-lg-8 col-sm-8">
                <ol class="breadcrumb pull-right">
                    <li><a href="index.php">Home</a></li>
                    <li class="active">Engineering Study - General Information</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container career-inner">
        <div class="row">
            <div class="col-md-12 career-head">
                <h1 class="wow fadeIn">Engineering Study - General Information</h1>
...
<div class="breadcrumbs">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-4">
                <h1>Inžinierske štúdium - Všeobecné informácie</h1>
            </div>
            <div class="col-lg-8 col-sm-8">
                <ol class="breadcrumb pull-right">
                    <li><a href="index.php">Domov</a></li>
                    <li class="active">Inžinierske štúdium - Všeobecné informácie</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="white-bg">
    ...
    <div class="container career-inner">
        <div class="row">
            <div class="col-md-12 career-head">
                <h1 class="wow fadeIn">Inžinierske štúdium - Všeobecné informácie</h1>
        ...
        <div class="row">
            <div class="col-md-12 wow fadeIn">
                <p class="align-left">
                <h2>Harmonogram inžinierského štúdia</h2>
                ...
                <h4>Zadanie diplomovej práce 13. 02. 2017</h4>
                <h4>Odovzdanie diplomovej práce 19. 05. 2017</h4>
                <h4>Štátne skúšky inžinierskeho štúdia 13. 06. 2017 – 16. 06. 2017</h4>
                <h4>Termín promócií 10. 07. 2017 – 14. 07. 2017</h4>
                </p>
            </div>
        </div>
        <hr>
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-4 career-contact">
                <p class="text-center wow pulse"><a href="./files/SP20162017i.pdf" download="SP20162017i.pdf">Kompletný
