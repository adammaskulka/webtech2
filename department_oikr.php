<?php 
	...
	if(isset($_GET['lang'])){
		...
		header("Location: department_oikr.php");
		exit();
	}
...
<head>
    ...
    <title>
        Ústav automobilovej mechatroniky FEI STU | Oddelenie informačných, komunikačných a riadiacich systémov
    </title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-4">
                <h1>Department of Information, Communication and Control Systems (OIKR)</h1>
            </div>
            <div class="col-lg-8 col-sm-8">
                <ol class="breadcrumb pull-right">
                    <li><a href="index.php">Home</a></li>
                    <li class="active">Department of Information, Communication and Control Systems (OIKR)</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container career-inner">
        <div class="row">
            <div class="col-md-12 career-head">
                <h1 class="wow fadeIn">Department of Information, Communication and Control Systems (OIKR)</h1>
            ...
            <div class="col-lg-6 col-sm-6 about-hiring">
                ...
                <div class="content">
                    <h3 class="title wow flipInX">
                        Department of Information, Communication and Control Systems (OIKR)
                    </h3>
...
<div class="breadcrumbs">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-4">
                <h1>Oddelenie informačných, komunikačných a riadiacich systémov (OIKR)</h1>
            </div>
            <div class="col-lg-8 col-sm-8">
                <ol class="breadcrumb pull-right">
                    <li><a href="index.php">Domov</a></li>
                    <li class="active">Oddelenie informačných, komunikačných a riadiacich systémov (OIKR)</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="white-bg">
    ...
    <div class="container career-inner">
        <div class="row">
            <div class="col-md-12 career-head">
                <h1 class="wow fadeIn">Oddelenie informačných, komunikačných a riadiacich systémov (OIKR)</h1>
