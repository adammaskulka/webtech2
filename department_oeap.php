<?php 
	...
	if(isset($_GET['lang'])){
		...
		header("Location: department_oeap.php");
		exit();
	}
...
<head>
    ...
    <title>
        Ústav automobilovej mechatroniky FEI STU | Oddelenie E-mobility, automatizácie a pohonov
    </title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-4">
                <h1>Oddelenie E-mobility, automatizácie a pohonov (OEAP)</h1>
            </div>
            <div class="col-lg-8 col-sm-8">
                <ol class="breadcrumb pull-right">
                    <li><a href="index.php">Domov</a></li>
                    <li class="active">Oddelenie E-mobility, automatizácie a pohonov (OEAP)</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container career-inner">
        <div class="row">
            <div class="col-md-12 career-head">
                <h1 class="wow fadeIn">Oddelenie E-mobility, automatizácie a pohonov (OEAP)</h1>
