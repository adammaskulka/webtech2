<?php 
	...
	if(isset($_GET['lang'])){
		...
		header("Location: department_oemp.php");
		exit();
	}
...
<head>
    ...
    <title>
        Ústav automobilovej mechatroniky FEI STU | Oddelenie elektroniky, mikropočítačov a PLC systémov
    </title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-4">
                <h1>Department of Electronics, Microcomputers and PLC (OEMP)</h1>
            </div>
            <div class="col-lg-8 col-sm-8">
                <ol class="breadcrumb pull-right">
                    <li><a href="index.php">Home</a></li>
                    <li class="active">Department of Electronics, Microcomputers and PLC (OEMP)</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container career-inner">
        <div class="row">
            <div class="col-md-12 career-head">
                <h1 class="wow fadeIn">Department of Electronics, Microcomputers and PLC (OEMP)</h1>
            ...
            <div class="col-lg-6 col-sm-6 about-hiring">
                ...
                <div class="content">
                    <h3 class="title wow flipInX">
                        Department of Electronics, Microcomputers and PLC (OEMP)
                    </h3>
...
<div class="breadcrumbs">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-4">
                <h1>Oddelenie elektroniky, mikropočítačov a PLC systémov (OEMP)</h1>
            </div>
            <div class="col-lg-8 col-sm-8">
                <ol class="breadcrumb pull-right">
                    <li><a href="index.php">Domov</a></li>
                    <li class="active">Oddelenie elektroniky, mikropočítačov a PLC systémov (OEMP)</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="white-bg">
    ...
    <div class="container career-inner">
        <div class="row">
            <div class="col-md-12 career-head">
                <h1 class="wow fadeIn">Oddelenie elektroniky, mikropočítačov a PLC systémov (OEMP)</h1>
