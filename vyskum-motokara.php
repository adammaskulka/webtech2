<?php 
	...
	if(isset($_GET['lang'])){
		...
		header("Location: vyskum-motokara.php");
		exit();
	}
...
<head>
    ...
    <title>
        Ústav automobilovej mechatroniky FEI STU | Výskum - Elektrická motokára
    </title>
...
<div class="breadcrumbs">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-4">
                <h1>Výskum - Elektrická motokára</h1>
            </div>
            <div class="col-lg-8 col-sm-8">
                <ol class="breadcrumb pull-right">
                    <li><a href="index.php">Domov</a></li>
                    <li class="active">Výskum - Elektrická motokára</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="white-bg">
    ...
    <div class="container career-inner">
        <div class="row">
            <div class="col-md-12 career-head">
                <h1 class="wow fadeIn">Výskum - Elektrická motokára</h1>
